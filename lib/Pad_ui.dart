...
class Tablet_ui extends StatefulWidget {
  const Tablet_ui({Key? key}) : super(key: key);

  @override
  State<Tablet_ui> createState() => _Tablet_uiState();
}

class _Tablet_uiState extends State<Tablet_ui> {
  @override
          ...
          SliverFillRemaining(
            ...
            child:  Column(
              ...
              children: [
                ...
                intro_item(percent: 0.6,title_font_size: 25,font_size: 14,),
                contact(percent: 0.6,title_font_size: 20,font_size: 12,),
                skill_item(percent: 0.6,title_font_size: 20,font_size: 12),
                edcation_item(percent: 0.6,title_font_size: 20,font_size: 12),

                awards_item(percent: 0.6,title_font_size: 20,font_size: 12),
                summary_project(percent: 0.6,title_font_size: 20,font_size: 12)
